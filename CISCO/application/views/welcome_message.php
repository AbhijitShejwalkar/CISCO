...
<div class="row">
  	<div class="col-lg-12 margin-tb">
  	  <div class="pull-left">
  	    <h2>CISCO : Network Routers Properties</h2>
  	  </div>
      ...
      <div class="modal-body">
            ...
            <form data-toggle="validator" action="<?php echo base_url(); ?>/items/store" method="POST" id="insert">
                ...
                <div class="form-group">
                    <label class="control-label" for="title">Sapid:</label>
                    <input type="text" name="sapid" class="form-control" maxlength="18"  data-error="Please enter sapid record." required />
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="hostname" class="form-control"   maxlength="14" data-error="Please enter hostname." required>
                    <div class="help-block with-errors"></div>
                </div>


				<div class="form-group">
                    <label class="control-label" for="title">Loopback</label>
                    <input type="text" name="loopback" class="form-control" data-error="Please enter Loopback." required />
                    <div class="help-block with-errors"></div>
                </div>
				...
				<div class="form-group">
                    ...
                    <input type="text" name="mac_address" class="form-control"  maxlength="17" data-error="Please enter mac address." required />
                    <div class="help-block with-errors"></div>
                </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <form data-toggle="validator" action="" method="put" id="update">
                ...
                <div class="form-group">
                    <label class="control-label" for="title">Sapid Record:</label>
                    <input type="text" name="sapid" class="form-control" data-error="Please enter sapid." required />
                    <div class="help-block with-errors"></div>
                </div>
...
<script type="text/javascript">
  var url = '<?php echo  base_url('/items') ?>';
</script>
